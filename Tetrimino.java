...
public abstract class Tetrimino implements Animatable
{
    ...
    public boolean moveLeft()
    {
       ...
       if(!end & _panel.canMove(newX1, newY1) & _panel.canMove(newX2, newY2)
        & _panel.canMove(newX3, newY3) & _panel.canMove(newX4, newY4)){
    ...
    public boolean moveDown()
    {
        ...
        if(_panel.canMove(newX1, newY1) & _panel.canMove(newX2, newY2)
        & _panel.canMove(newX3, newY3) & _panel.canMove(newX4, newY4)){
         _block1.setLocation(newX1, newY1);
         _block2.setLocation(newX2, newY2);
         _block3.setLocation(newX3, newY3);
         ...
         return true;
            ...
            if(!end){
            _panel.addToBoard((int)_block1.getY(), (int)_block1.getX(), _block1);
           
            _panel.addToBoard((int)_block2.getY(), (int)_block2.getX(), _block2);
            _panel.addToBoard((int)_block3.getY(), (int)_block3.getX(), _block3);
            _panel.addToBoard((int)_block4.getY(), (int)_block4.getX(), _block4);
        }
        end = true;
               return false;
